 ...
 */
@Entity(name="stock_day_five")
public class StockDayFive implements Comparable<StockDayFive>{
    @Id
    @GeneratedValue
    private Long id;
    ...
    public StockDayFive(String code, String name){
        this.code =code;
        this.name = name;
    ...
    @Override
    public int compareTo(StockDayFive o) {

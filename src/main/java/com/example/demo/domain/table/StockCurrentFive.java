 ...
 */
@Entity(name="stock_current_five")
public class StockCurrentFive implements Comparable<StockCurrentFive>{
    @Id
    @GeneratedValue
    private Long id;
    ...
    @Override
    public int compareTo(StockCurrentFive o) {
